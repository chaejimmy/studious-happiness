...
struct RoomGridView: View {
    @Binding var selectedPlace: [PlaceType]
    ...
    func gridItemView() -> some View {
            ...
            return GeometryReader { geo in
                ZStack(alignment: .topLeading, content: {
                    ForEach(PlaceType.allCases, id: \.data.title) { rooms in
                        ChipView(
                        ...
                        .padding(.vertical, 6)
                            .alignmentGuide(.leading) { dimension in
                                ...
                                let result = width
                                if rooms.data.title == PlaceType.allCases.last!.data.title {
                                    width = 0
                                } else {
    ...
    private func roomSelection(roomType: PlaceType) {
