//
//  StandardAmentitiesGridView.swift
//  Totel (iOS)
//
...
struct StandardAmentitesGridView: View {
    @Binding var selectedPlace: [StandardAmentities]
    ...
    func gridItemView() -> some View {
            ...
            return GeometryReader { geo in
                ZStack(alignment: .topLeading, content: {
                    ForEach(StandardAmentities.allCases, id: \.data.title) { rooms in
                        ChipView(
                        ...
                        .padding(.vertical, 8)
                            .alignmentGuide(.leading) { dimension in
                                ...
                                let result = width
                                if rooms.data.title == StandardAmentities.allCases.last!.data.title {
                                    width = 0
                                } else {
    ...
    private func roomSelection(roomType: StandardAmentities) {
